...
const Footer = () => {
  ...
  return (
    <section className="bg-black text-white px-6 md:px-16 py-10 relative">
      {/* Top paragraph */}
      <div className="max-w-2xl mb-6 mr-auto">
      ...
      {/* Divider Line */}
      <div className="border-t border-white/20 w-full h-[1px] mb-4"></div>
